...
if (first == 1) {
        ...
        if (optionsAC == 1) {
            ...
            switch (optionsA) {
                case 1:
                    ...
                    window.location.href = './html/add_campers.html';
                    break;
                case 2:
            ...
            switch (optionR) {
                case 1:
                alert("Rutas de entrenamiento: ");
                window.location.href = './html/views_routes.html';
                break;
                case 2: 
                alert("Has ingresado a la sección de crear rutas.");
                window.location.href =  './html/add_routes.html';
                alert("Felicidades has creado la ruta con exito!");
                break;
                case 3:
                alert("Estamos en construccion, Recarga la página");
                break;
            } 
        } else if (optionsAC == 4) {
    ...
    if (optionsT == 1) {
        ...
        alert("Estamos en mantenimiento, recarga la pagina");
} else if (rta == 3) {
